    ...
    try {
      ...
      const normalized = raw.map((v) => {
        ...
        return {
          ...
          image: vendorImages[shopNameForImage] || FALLBACK_IMAGE,
          categories: ["General"],
        ...
        <View style={styles.headerRight}>
          <TouchableOpacity onPress={() => navigation.navigate("StudentTabs", { screen: "Orders" })}>
            <View style={styles.ordersBtn}>
              <Ionicons name="list" size={20} color="#0f1724" />
            </View>
          </TouchableOpacity>
      ...
      <View style={styles.container}>
        <View style={styles.searchRow}>
          ...
          <TouchableOpacity style={styles.filterBtn} onPress={() => fetchVendors(true)}>
            <Ionicons name="refresh" size={20} color="#0f1724" />
          </TouchableOpacity>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={{ padding: 20, alignItems: 'center' }}>
                <Text style={{ color: "#9aa1a9", marginTop: 20 }}>No vendors found</Text>
                {vendors.length === 0 && (
...
const styles = StyleSheet.create({
  ...
  ordersBtn: { backgroundColor: palette.gold, padding: 10, borderRadius: 10, marginRight: 8 },
